...
var BaseRecord = /** @class */ (function () {
    function BaseRecord(id, type, _options, castName) {
        var _this = this;
...
var List = /** @class */ (function (_super) {
    ...
    function List(id, items, options, className) {
        var _this = _super.call(this, id, RecordType.LIST, options, className) || this;
        _this._items = items;
    ...
    List.prototype._getState = function () {
        return this._options.adapter.castValue(this._items.map(function (item) { return item.getState(); }), this.castName);
    };
    return List;
}(BaseParent));
exports.List = List;
var Map = /** @class */ (function (_super) {
    ...
    function Map(id, properties, options, className) {
        var _this = _super.call(this, id, RecordType.MAP, options, className) || this;
    ...
    Map.prototype.setValue = function (propertyName, value) {
        ...
        if (value == null) {
            ...
            this.changeObservable.dispatch({ id: this._options.generateId(), type: mutations_1.MutationType.MAP_UNSET, oldValueId: oldItem && oldItem.id, targetId: this.id, propertyName: propertyName, });
        }
        else {
            this._properties[propertyName] = value;
            this.changeObservable.dispatch({ id: this._options.generateId(), type: mutations_1.MutationType.MAP_SET, targetId: this.id, propertyName: propertyName, value: value, });
        }
    };
...
var Primitive = /** @class */ (function (_super) {
    ...
    function Primitive(id, value, options, className) {
        var _this = _super.call(this, id, RecordType.PRIMITIVE, options, className) || this;
        _this._value = value;
        return _this;
    }
...
exports.$recordCreator = function (options) {
    if (options === void 0) { options = {}; }
    var _options = Object.assign({}, exports.DEFAULT_RECORD_OPTIONS, options);
    var createRecord = function (value) {
        if (_options.adapter.isList(value)) {
            ...
            var properties_1 = {};
            _options.adapter.each(value, function (item, key) {
                properties_1[key] = createRecord(item);
            });
            return new Map(_options.generateId(), properties_1, _options, _options.adapter.getCastName(value));
        }
        else {
...
exports.$deserializeRecord = function (item, options) {
    ...
    switch (item.type) {
        ...
        case RecordType.LIST: {
            return new List(item.id, item.items.map(function (value) { return exports.$deserializeRecord(value, options); }), options, item.castName);
        }
    }
};
var $castRecord = function (record, options) {
